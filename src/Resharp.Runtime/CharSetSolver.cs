...
namespace Resharp.Runtime
{
...

    {
        ...
        public string PrettyPrint(BDD set)
        {
            ...
            {
                return
                    @"."; // technically this is only accurate with RegexOptions.Singleline, but it's cleaner than using [\s\S]
            }
